...
func NewAppContainer(cfg *config.Config) (*AppContainer, error) {
	...
	return &AppContainer{
		...
		BFF:      bffClient,
		Cities:   catalog,
		QueryAds: queryadsContainer.NewQueryAdsContainer(cfg, reg, catalog, cdnClient, bffClient),
		...
		Category: categoryContainer.NewCategoryContainer(cdnClient),
		Location: locationContainer.NewLocationContainer(cdnClient, cfg),
